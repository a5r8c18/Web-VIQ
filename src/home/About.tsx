...
const About = () => {
  return (
    <>
      {/* Slide 1: Intro */}
      <section className="relative z-[1] transform-gpu sticky top-0 shadow-[0_-10px_40px_rgba(0,0,0,0.5)] min-h-[100dvh] py-20 flex items-center bg-[var(--color-bg-primary)] border-y border-strobe-gold">
      ...
      {/* Slide 2: Stats */}
      <section className="relative z-[2] transform-gpu sticky top-0 shadow-[0_-10px_40px_rgba(0,0,0,0.5)] min-h-[100dvh] py-20 flex items-center bg-[var(--color-bg-primary)] border-y border-strobe-gold">
        <div className="container-custom">
          <motion.div
            initial="hidden"
            whileInView="visible"
            ...
            variants={fadeUp}
            custom={1}
            className="grid sm:grid-cols-2 lg:grid-cols-4 gap-px bg-[var(--color-border-default)] border border-[var(--color-border-default)]"
          >
            {stats.map((stat) => (
      ...
      {/* Slide 3: Clients */}
      <section className="relative z-[3] transform-gpu sticky top-0 shadow-[0_-10px_40px_rgba(0,0,0,0.5)] min-h-[100dvh] py-20 flex items-center bg-[var(--color-bg-primary)] border-y border-strobe-gold">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-px bg-[var(--color-border-default)] border border-[var(--color-border-default)]">
            {clients.map((p) => (
      ...
      {/* Slide 4: CTA */}
      <section className="relative z-[4] transform-gpu sticky top-0 shadow-[0_-10px_40px_rgba(0,0,0,0.5)] min-h-[100dvh] py-20 flex items-center bg-[var(--color-bg-primary)] border-y border-strobe-gold">
        <div className="container-custom">
          <motion.div
            initial="hidden"
            whileInView="visible"
            ...
            variants={fadeUp}
            custom={2}
            className="relative transform-gpu overflow-hidden border border-[var(--color-border-default)] bg-background-secondary"
          >
