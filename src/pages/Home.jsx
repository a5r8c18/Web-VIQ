      ...
      <section className="section-padding bg-secondary-800">
        <div className="container-custom">
          ...
          <div className="text-center mt-12">
            <Link to="/servicios" className="btn-primary inline-flex items-center space-x-2">
      ...
      <section className="section-padding bg-gold-600">
        <div className="container-custom text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/registro" className="bg-secondary-900 text-gold-400 hover:bg-secondary-800 font-medium py-3 px-8 rounded-lg transition-colors duration-200">
              Comenzar Ahora
            </Link>
            <Link to="/servicios" className="bg-transparent border-2 border-secondary-900 text-secondary-900 hover:bg-secondary-900 hover:text-gold-400 font-medium py-3 px-8 rounded-lg transition-colors duration-200">
              Ver Servicios
            </Link>
          </div>
        </div>
