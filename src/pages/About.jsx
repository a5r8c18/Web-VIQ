...
const About = () => {
  return (
    <div className="min-h-screen bg-gray-800 text-gray-100 dark:bg-gray-900 py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            About <span className="text-yellow-400">VIQ Systems</span>
          </h1>
        ...
        >
          <div className="prose dark:prose-invert max-w-none">
            ...
            <div className="mt-10 pt-8 border-t border-gray-600 dark:border-gray-700">
              <h3 className="text-2xl font-semibold text-white dark:text-white mb-4">Our Mission</h3>
              ...
              <h3 className="text-2xl font-semibold text-white dark:text-white mb-4 mt-8">Our Values</h3>
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  ...
                  <div key={index} className="bg-gray-600/30 dark:bg-gray-700/50 p-5 rounded-xl backdrop-blur-sm">
                    <h4 className="font-medium text-lg text-yellow-400 dark:text-yellow-400 mb-2">{item.title}</h4>
                    <p className="text-gray-200 dark:text-gray-300">{item.description}</p>
                  </div>
                ))}
              </div>
            </div>
